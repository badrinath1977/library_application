...
PUBLIC_PATHS = {"/health", "/live", "/ready", "/docs", "/redoc", "/openapi.json"}
...
class AuthMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:  # type: ignore[no-untyped-def]
        if request.url.path in PUBLIC_PATHS or request.url.path.startswith("/docs/") or not self._settings.auth_enabled:
