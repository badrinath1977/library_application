"""Build automation for the Keyvault_library project."""
...
def main() -> int:
    ...
    try:
        print_step("Starting keyvault-library build")
...
def run_commands() -> None:
    ...
    commands = [
        ...
        [sys.executable, "-m", "mypy", "keyvault_library"],
        [sys.executable, "-m", "pip_audit"],
        [sys.executable, "-m", "pytest", "--cov=keyvault_library"],
...
def print_step(message: str) -> None:
    """Print a build progress message."""

    print(f"[keyvault-library build] {message}")
